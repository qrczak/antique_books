 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_antique_books']['zbior']   = array('Zbiór', 'Wprowadź nazwę zbioru');
$GLOBALS['TL_LANG']['tl_antique_books']['nrInwent']   = array('Numer inwentarzowy', 'Wprowadź numer inwentarzowy.');
$GLOBALS['TL_LANG']['tl_antique_books']['sygnatury']   = array('Opisy sygnatur', 'Wprowadź opisy sygnatur.');
...
$GLOBALS['TL_LANG']['tl_antique_books']['sygPlacePub']   = 'Miejsce publikacji';
$GLOBALS['TL_LANG']['tl_antique_books']['sygPublisher']   = 'Oficyna';
$GLOBALS['TL_LANG']['tl_antique_books']['sygSubject']   = 'Temat';
$GLOBALS['TL_LANG']['tl_antique_books']['sygIll']   = 'Illustracje';
$GLOBALS['TL_LANG']['tl_antique_books']['oldSygnatury']   = array('Dawne sygnatury', 'Wprowadź dawne sygnatury.');
$GLOBALS['TL_LANG']['tl_antique_books']['height']   = array('Wysokość (cm)', 'Wprowadź wysokość w centymetrach.');
$GLOBALS['TL_LANG']['tl_antique_books']['width']   = array('Szerokość (cm)', 'Wprowadź szerokość w centymetrach.');
$GLOBALS['TL_LANG']['tl_antique_books']['eksl']   = array('Ekslibris', 'Wprowadź ekslibris.');
$GLOBALS['TL_LANG']['tl_antique_books']['supEksl']   = array('Superekslibris', 'Wprowadź superekslibris.');
$GLOBALS['TL_LANG']['tl_antique_books']['pieczatki']   = array('Pieczątki', 'Wprowadź pieczątki.');
$GLOBALS['TL_LANG']['tl_antique_books']['znakiWlas']   = array('Inne znaki własnościowe', 'Wprowadź inne znaki własnościowe.');
$GLOBALS['TL_LANG']['tl_antique_books']['zewOznacz']   = array('Zewnętrzne oznaczenia', 'Wybierz zewnętrzne oznaczenia.');
$GLOBALS['TL_LANG']['tl_antique_books']['drRekMarg']   = array('Druk/rękopis/marginalia', 'Wprowadź .');
$GLOBALS['TL_LANG']['tl_antique_books']['arkMat']   = array('Arkusze – materiał', 'Jaki jest materiał arkuszy?');
$GLOBALS['TL_LANG']['tl_antique_books']['zdobKraw']   = array('Zdobienia krawędzi', 'Jakie są zdobienia krawędzi?');
$GLOBALS['TL_LANG']['tl_antique_books']['oblMat']   = array('Obleczenie – materiał ', 'Jaki jest materiał obleczenia?');
$GLOBALS['TL_LANG']['tl_antique_books']['oblKolor']   = array('Obleczenie – kolor ', 'Jaki jest kolor obleczenia?');
$GLOBALS['TL_LANG']['tl_antique_books']['okladziny']   = array('Okładziny', 'Wybierz rodzaj okładziny.');
$GLOBALS['TL_LANG']['tl_antique_books']['zdobOprawy']   = array('Zdobienia oprawy', 'Wybierz zdobienia oprawy.');
$GLOBALS['TL_LANG']['tl_antique_books']['zapWiazOkucia']   = array('Zapinki/wiązania/okucia', 'Wybierz.');
$GLOBALS['TL_LANG']['tl_antique_books']['charZapWiaz']   = array('Charakterystyka zapinek/wiązań', 'Wprowadź charakterystykę zapinek/wiązań.');
$GLOBALS['TL_LANG']['tl_antique_books']['cover']   = array('Okładziny – zniszczenia', 'Jakie są zniszczenia');
$GLOBALS['TL_LANG']['tl_antique_books']['grzbiet']   = array('Grzbiet', 'Stan grzbietu.');
$GLOBALS['TL_LANG']['tl_antique_books']['konstru']   = array('Konstrukcja', 'Stan konstrukcji.');
$GLOBALS['TL_LANG']['tl_antique_books']['szycie']   = array('Szycie', 'Stan szucia.');
$GLOBALS['TL_LANG']['tl_antique_books']['kapitalki']   = array('Kapitałki', 'Jakie są zniszczenia');
$GLOBALS['TL_LANG']['tl_antique_books']['oblUbyt']   = array('Obleczenie – ubytki', 'Ubytki obleczenia.');
$GLOBALS['TL_LANG']['tl_antique_books']['oblZnisz']   = array('Obleczenie – zniszczenia', 'Zniszczenia obleczenia.');
$GLOBALS['TL_LANG']['tl_antique_books']['zapWiaz']   = array('Zapinki/wiązania', 'Stan zapinek i wiązań.');
$GLOBALS['TL_LANG']['tl_antique_books']['zabOpr']   = array('Zabrudzenie oprawy', 'Stan zabrudzenia oprawy.');
$GLOBALS['TL_LANG']['tl_antique_books']['blokKompl']   = array('Blok – kompletność', 'Jak kompletny jest blok?');
$GLOBALS['TL_LANG']['tl_antique_books']['defBloku']   = array('Deformacje bloku', 'czy blok jest zdeformowany?');
$GLOBALS['TL_LANG']['tl_antique_books']['zMechBloku']   = array('Zniszczenia mechaniczne bloku', 'Czy występują zniszczenia mechaniczne bloku?');
$GLOBALS['TL_LANG']['tl_antique_books']['zabBlokuWykl']   = array('Zabrudzenia bloku i wyklejek', 'Czy występują zabrudzenia bloku i wyklejek?');
$GLOBALS['TL_LANG']['tl_antique_books']['oslPapier']   = array('Osłabiony papier', 'Jak papier jest osłabiony?');
$GLOBALS['TL_LANG']['tl_antique_books']['kruPapier']   = array('Kruchy papier', 'Jak papier jest kruchy?');
$GLOBALS['TL_LANG']['tl_antique_books']['zacZal']   = array('Zacieki/zalania', 'Stan pod względem zacieków lub zalań.');
$GLOBALS['TL_LANG']['tl_antique_books']['mikroOrg']   = array('Mikroorganizmy', 'Ubytki spowodowane przez mikroorganizmy.');
$GLOBALS['TL_LANG']['tl_antique_books']['foxing']   = array('Foxing', 'Oceń foxing.');
$GLOBALS['TL_LANG']['tl_antique_books']['owady']   = array('Owady', 'Ubytki spowodowane przez owady.');
$GLOBALS['TL_LANG']['tl_antique_books']['sumaNum']   = array('Suma zniszczeń', 'Suma zniszczeń woluminu');
$GLOBALS['TL_LANG']['tl_antique_books']['dezynfek']   = array('Dezynfekcja', 'Wprowadź informacje o dezynfekcji.');
$GLOBALS['TL_LANG']['tl_antique_books']['napKonserw']   = array('Naprawy/konserwacje', 'Wprowadź informacje o naprawach/konserwacji.');
$GLOBALS['TL_LANG']['tl_antique_books']['uwagi']   = array('Uwagi', 'Uwagi końcowe.');
$GLOBALS['TL_LANG']['tl_content']['paczkaDownl']   = array('Plik do pobrania', 'Wpisz nazwę pliku łącznie z rozszerzeniem ze źródłowymi zdjęciami w pełnej rozdzielczości. Nazwa pliku nie powinna zawierać polskich znaków diakrytycznych oraz spacji.');
$GLOBALS['TL_LANG']['tl_content']['galUwagi']   = array('Galeria działu Uwagi', 'Proszę wybrać pliki lub katalog ze zdjęciami.');
$GLOBALS['TL_LANG']['tl_content']['galZach']   = array('Galeria działu Stan Zachowania', 'Proszę wybrać pliki lub katalog ze zdjęciami.');
$GLOBALS['TL_LANG']['tl_content']['galIdent']   = array('Galeria działu Identyfikacja', 'Proszę wybrać pliki lub katalog ze zdjęciami.');
...
$GLOBALS['TL_LANG']['tl_antique_books']['listdrRekMarg']['D+R']	= 'Druk oraz rękopis';
$GLOBALS['TL_LANG']['tl_antique_books']['listdrRekMarg']['D+R+M']	= 'Druk, rękopis oraz marginalia';
$GLOBALS['TL_LANG']['tl_antique_books']['listdrRekMarg']['D+M']	= 'Druk oraz marginalia';
...
$GLOBALS['TL_LANG']['tl_antique_books']['listZapWiazOkucia']['Z+O']	= 'Zapinki oraz okucia';
$GLOBALS['TL_LANG']['tl_antique_books']['listZapWiazOkucia']['Z+O+Ł']	= 'Zapinki, okucia oraz łańcuch';
$GLOBALS['TL_LANG']['tl_antique_books']['listZapWiazOkucia']['Z+Ł']	= 'Zapinki oraz łańcuch';
 ...
 * Fields legends
 */
$GLOBALS['TL_LANG']['tl_antique_books']['zbiorLeg_legend']   = 'Zbiór oraz numer inwetarzowy';
$GLOBALS['TL_LANG']['tl_antique_books']['imgInwent_legend']   = 'Zdjęcie zbioru';
$GLOBALS['TL_LANG']['tl_antique_books']['sygOpis_legend']   = 'Sygnatury';
$GLOBALS['TL_LANG']['tl_antique_books']['stZachow_legend']   = 'Stan zachowania';
$GLOBALS['TL_LANG']['tl_antique_books']['uwKonc_legend']   = 'Uwagi końcowe';
...
$GLOBALS['TL_LANG']['tl_antique_books']['edit']   = array('Edytuj wolumin', 'Edytuj wolumin ID %s');
$GLOBALS['TL_LANG']['tl_antique_books']['copy']   = array('Kopiuj wolumin', 'Kopiuj wolumin ID %s');
$GLOBALS['TL_LANG']['tl_antique_books']['delete'] = array('Usuń wolumin', 'Usuń wolumin ID %s');
$GLOBALS['TL_LANG']['tl_antique_books']['show']   = array('Szczegóły woluminu', 'Pokaż szczegóły woluminu ID %s');
